DEFAULT_CHAT_FRAME:AddMessage("timer.lua is loading")
--------------------------------------------------------
-- Namespaces
--------------------------------------------------------
...
function Timer:CreateButton(point, relativeFrame, relativePoint, yOffset, text)
...
function Timer:CreateSlider(point, relativeFrame, relativePoint, yOffset, value, valueStep)
